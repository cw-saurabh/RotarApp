...
class GBM(models.Model):
    ...
    gbm1    = models.DateTimeField(verbose_name = "Date", default=datetime.now)
    gbm2    = models.CharField(max_length=100,verbose_name = "Agenda")
...
class BOD(models.Model):
    ...
    bod1    = models.DateTimeField(verbose_name = "Date", default=datetime.now)
    bod2    = models.CharField(max_length=100,verbose_name = "Agenda")
...
class Event(models.Model):
    club        = models.ForeignKey(Account, on_delete = models.CASCADE)
    reportId    = models.ForeignKey(Report, on_delete = models.CASCADE)
    event0      = models.DateTimeField(verbose_name = "Date", default=datetime.now)
    event1      = models.CharField(max_length=15,verbose_name = "Name")
...
class FutureEvent(models.Model):
    club            = models.ForeignKey(Account, on_delete = models.CASCADE)
    reportId        = models.ForeignKey(Report, on_delete = models.CASCADE)
    futureEvent0     = models.DateTimeField(verbose_name = "Date", default=datetime.now)
    futureEvent1     = models.CharField(max_length=15,verbose_name = "Name")
    futureEvent2     = models.CharField(max_length=100,verbose_name = "Description")
