...
function appendGeneralBodyMeeting() {
    ...
    <div class="row" id="gbm`+gbmsIndex+`">
        ...
        <div class="col-lg-8">
            ...
            <input autocomplete="off" onchange="updateProgress()"  type="text" maxlength='700' id="gbm`+gbmsIndex+`-2" name="gbm`+gbmsIndex+`-2">
        </div>
        <div class="col-lg-2">
    ...
    requiredFields['Admin'].push(`gbm`+gbmsIndex+`-0`,`gbm`+gbmsIndex+`-2`,`gbm`+gbmsIndex+`-3`,`gbm`+gbmsIndex+`-4`,`gbm`+gbmsIndex+`-5`);
...
function appendBoardOfDirectorsMeeting() {
    ...
    <div class="row" id="bod`+bodsIndex+`">
        ...
        <div class="col-lg-8">
            <p class="label"><i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;&nbsp;Agenda of the Meeting (brief)<b style="color:red"> *</b></p><br>
            <input autocomplete="off" onchange="updateProgress()"  type="text" maxlength="700" id="bod`+bodsIndex+`-2" name="bod`+bodsIndex+`-2">
        </div>
        <div class="col-lg-2">
            <p class="label">ByLaws Passed?<b style="color:red"> *</b></p><br>
    ...
    `);
    requiredFields['Admin'].push(`bod`+bodsIndex+`-0`,`bod`+bodsIndex+`-2`,`bod`+bodsIndex+`-3`,`bod`+bodsIndex+`-4`,`bod`+bodsIndex+`-5`);
...
function appendFutureEvent() {
    ...
    <div class="row" id="futureEvent`+futureEventsIndex+`" >
        ...
        <div class="col-lg-2">
            ...
            <input autocomplete="off" onchange="updateProgress()" maxlength="35" type="text" id="futureEvent`+futureEventsIndex+`-1" name="futureEvent`+futureEventsIndex+`-1">
        </div>
        <div class="col-lg-4">
            <p class="label"><i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;&nbsp;Details<b style="color:red"> *</b></p><br>
            <input autocomplete="off" onchange="updateProgress()" maxlength="700" type="text" id="futureEvent`+futureEventsIndex+`-2" name="futureEvent`+futureEventsIndex+`-2">
        </div>
        <div class="col-lg-2">
    ...
    requiredFields['Others'].push(`futureEvent`+futureEventsIndex+`-1`,`futureEvent`+futureEventsIndex+`-2`,`futureEvent`+futureEventsIndex+`-3`);
...
function appendEvent() {
    ...
    <div class="row" id="event`+eventsIndex+`" >
        ...
        <div class="col-lg-3">
            ...
            <input autocomplete="off" onchange="updateProgress()" maxlength="35" type="text" id="event`+eventsIndex+`-1" name="event`+eventsIndex+`-1">
        </div>
        <div class="col-lg-3">
            <p class="label"><i class="fa fa-hashtag" aria-hidden="true"></i>&nbsp;&nbsp;Avenue<b style="color:red"> *</b></p><br>
        ...
        <div class="col-lg-5">
            ...
            <input autocomplete="off" onchange="updateProgress()"  type="text" maxlength="700" id="event`+eventsIndex+`-6" name="event`+eventsIndex+`-6">
        </div>
        <div class="col-lg-3">
    ...
    requiredFields['Avenue'].push(`event`+eventsIndex+`-1`,`event`+eventsIndex+`-2`,`event`+eventsIndex+`-3`,`event`+eventsIndex+`-4`,`event`+eventsIndex+`-5`,`event`+eventsIndex+`-6`,`event`+eventsIndex+`-7`);
...
function deleteRow(dataType, clicked) {
    ...
    {
        eventsCount-=1;
        let index = requiredFields['Avenue'].indexOf(target+"-1");
        let n = 7;
    ...
    {
        futureEventsCount-=1;
        let index = requiredFields['Others'].indexOf(target+"-1");
        let n = 3;
